...
func RenderEditor(c *render.ComponentContext, p models.Page, children func(c *render.ComponentContext) error) error {
	...
	c.WriteString(" @close=\"newTodo = false\"")
	c.WriteString(">")
	c.WriteString(`<div`)
	...
	c.WriteString(" @click=\"newTodo = true\"")
	c.WriteString(">")
	c.WriteString(`<span`)
	...
	c.WriteString(`</div>`)
	c.WriteString(`<div`)
	c.WriteString(" class=\"todo-modal\"")
	c.WriteString(" x-show=\"newTodo\"")
	c.WriteString(" x-cloak=\"\"")
	c.WriteString(" x-transition.opacity=\"\"")
	c.WriteString(">")
	c.WriteString(`<div`)
	c.WriteString(" class=\"todo-modal-backdrop\"")
	c.WriteString(" @click=\"newTodo = false\"")
	c.WriteString(">")
	c.WriteString(`</div>`)
	c.WriteString(`<div`)
	c.WriteString(" class=\"todo-modal-card dashboard-card\"")
	c.WriteString(" role=\"dialog\"")
	c.WriteString(" aria-modal=\"true\"")
	c.WriteString(">")
	c.WriteString(`<div`)
	...
	c.WriteString(`<button`)
	c.WriteString(" type=\"button\"")
	c.WriteString(" class=\"modal-close\"")
	c.WriteString(" @click=\"newTodo = false\"")
	...
	c.WriteString(" hx-target=\"#todo-table\"")
	c.WriteString(" hx-swap=\"outerHTML\"")
	c.WriteString(" hx-on::after-swap=\"$dispatch('close')\"")
	c.WriteString(">")
	c.WriteString(`<div`)
